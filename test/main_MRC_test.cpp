...
struct inp_request : public cadmium::in_port<Message_t>{};

/***** Define output ports for coupled model *****/
struct outp_response : public cadmium::out_port<Message_t>{};
struct outp_inetSent : public cadmium::out_port<Message_t>{};
...
int main(){
    ...
    const char * i_input_data = "../input_data/MRC_input_test_request_In.txt";
    ...
    dynamic::modeling::Ports oports_TOP = {typeid(outp_response), typeid(outp_inetSent)};
    dynamic::modeling::Models submodels_TOP = {input_reader, MRC};
    dynamic::modeling::EICs eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP = {
        dynamic::translate::make_EOC<outp_response, outp_response>("MRC"),
        dynamic::translate::make_EOC<outp_inetSent, outp_inetSent>("MRC"),
    };
    dynamic::modeling::ICs ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<Message_t>::out, inp_request>("input_reader","MRC")
    };
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/MRC_test_output_messages.txt");
    struct oss_sink_messages{
        static ostream& sink(){          
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/MRC_test_output_state.txt");
